...
namespace PGS.Utils
{
    public class CultureSingleton
    {
        
        /// <summary>
        ///     Static read-only instance.
        /// </summary>
        protected static readonly CultureSingleton m_instance = new CultureSingleton();
        
        /// <summary>
        ///     Hidden constructor called during static member <c>m_instance</c> 
        ///     initialization.
        /// </summary>
        protected CultureSingleton() { }

        /// <summary>
        ///     Gets the only instance of the object.
        /// </summary>
        public static CultureSingleton Instance
        {
